...
export class GetTimeOffRequestDto extends PaginationDto {
  @ApiPropertyOptional({ description: 'User ID to filter by', example: 'user_abc123' })
  @IsOptional()
  @IsString()
  userId?: string;

  @ApiPropertyOptional({ description: 'Filter requests starting from this date (ISO string)', example: '2023-01-01T00:00:00Z' })
  @IsOptional()
  @IsDateString()
  startDate?: string;

  @ApiPropertyOptional({ description: 'Filter requests up to this date (ISO string)', example: '2023-01-31T23:59:59Z' })
  @IsOptional()
  @IsDateString()
  endDate?: string;
}