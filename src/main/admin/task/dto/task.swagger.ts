...
export const updateTaskSwaggerSchema = {
  ...
  properties: {
    ...
    startTime: { type: 'string', format: 'date-time', example: '2025-08-02T08:00:00Z' },
    endTime: { type: 'string', format: 'date-time', example: '2025-08-02T17:00:00Z' },
    location: { type: 'string', example: 'Dhaka Main Office' },
    labels: { type: 'array', items: { type: 'string' }, example: ['UI', 'Bugfix'] },
