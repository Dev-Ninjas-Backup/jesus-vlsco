...
-- CreateEnum
CREATE TYPE "JopTitle" AS ENUM ('BACK_END_DEVELOPER', 'FRONT_END_DEVELOPER', 'FULL_STACK_DEVELOPER', 'MOBILE_DEVELOPER', 'UI_DEVELOPER', 'UX_DEVELOPER', 'SEALS_ENGINEER', 'DATA_SCIENTIST', 'DATA_ANALYST', 'DATA_ENGINEER');
